...
namespace GRINS
{
  ...
  private:
    ...
    std::unique_ptr<libMesh::NumericVector<libMesh::Number>> _old_old_local_nonlinear_solution;
    ...
    void compute_prev_timestep_deform_gradient( AssemblyContext & solid_context,
